...
create table user (id bigint not null auto_increment, created TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, email varchar(255) not null, first_name varchar(255) not null, last_name varchar(255) not null, password varchar(255) not null, role_id int default 1 not null, primary key (id)) engine=InnoDB;
